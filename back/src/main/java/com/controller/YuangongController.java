...
//                            yuangongEntity.setXueliTypes(Integer.valueOf(data.get(0)));   //学历状态 要改的
//                            yuangongEntity.setYuangongJiaoyuContent("");//详情和图片
//                            yuangongEntity.setYuangongGongzuoContent("");//详情和图片
//                            yuangongEntity.setShangpinShixiContent("");//详情和图片
//                            yuangongEntity.setShangpinRonguContent("");//详情和图片
