        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '附件' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.jixiaoFile" placeholder="附件" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/renshiguanli/upload/jixiaoMuBan.xls"
                        >批量导入绩效数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jixiao','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.jixiaoFile!= '' && this.searchForm.jixiaoFile!= undefined) {
                    params['jixiaoFile'] = '%' + this.searchForm.jixiaoFile + '%'
                }
