    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="培训编号" prop="peixunUuidNumber">
                       <el-input v-model="ruleForm.peixunUuidNumber"
                                 placeholder="培训编号" clearable  :readonly="ro.peixunUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="培训编号" prop="peixunUuidNumber">
                           <el-input v-model="ruleForm.peixunUuidNumber"
                                     placeholder="培训编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="培训标题" prop="peixunName">
                       <el-input v-model="ruleForm.peixunName"
                                 placeholder="培训标题" clearable  :readonly="ro.peixunName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="培训标题" prop="peixunName">
                           <el-input v-model="ruleForm.peixunName"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.kaishiTime"  class="input" label="培训开始时间" prop="kaishiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaishiTime" label="培训开始时间" prop="kaishiTime">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jieshuTime"  class="input" label="培训结束时间" prop="jieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jieshuTime" label="培训结束时间" prop="jieshuTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.peixunContent"  label="培训内容" prop="peixunContent">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yuangongId: '',
                    peixunUuidNumber: new Date().getTime(),
                    peixunName: '',
                    peixunTypes: '',
                    kaishiTime: '',
                    jieshuTime: '',
                ...
                rules: {
                   ...
                   peixunUuidNumber: [
                              { required: true, message: '培训编号不能为空', trigger: 'blur' },
                          ],
                   peixunName: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.peixunContent = _this.ruleForm.peixunContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.peixunContent = this.ruleForm.peixunContent.replaceAll(this.$base.url,"");
                        this.$http({
