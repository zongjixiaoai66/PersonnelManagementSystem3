        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学历状态" prop="xueliTypes">
                        <el-select v-model="ruleForm.xueliTypes" :disabled="ro.xueliTypes" placeholder="请选择学历状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学历状态" prop="xueliValue">
                        <el-input v-model="ruleForm.xueliValue"
                            placeholder="学历状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yuangongJiaoyuContent"  label="教育经历" prop="yuangongJiaoyuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuangongJiaoyuContent" label="教育经历" prop="yuangongJiaoyuContent">
                            <span v-html="ruleForm.yuangongJiaoyuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yuangongGongzuoContent"  label="工作经历" prop="yuangongGongzuoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuangongGongzuoContent" label="工作经历" prop="yuangongGongzuoContent">
                            <span v-html="ruleForm.yuangongGongzuoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shangpinShixiContent"  label="实习经历" prop="shangpinShixiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangpinShixiContent" label="实习经历" prop="shangpinShixiContent">
                            <span v-html="ruleForm.shangpinShixiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shangpinRonguContent"  label="所获荣誉" prop="shangpinRonguContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangpinRonguContent" label="所获荣誉" prop="shangpinRonguContent">
                            <span v-html="ruleForm.shangpinRonguContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yuangongEmail: false,
                    xueliTypes: false,
                    yuangongJiaoyuContent: false,
                    yuangongGongzuoContent: false,
                    shangpinShixiContent: false,
                    shangpinRonguContent: false,
                    jinyongTypes: false,
                },
                ruleForm: {
                    username: '',
                    ...
                    yuangongEmail: '',
                    xueliTypes: '',
                    yuangongJiaoyuContent: '',
                    yuangongGongzuoContent: '',
                    shangpinShixiContent: '',
                    shangpinRonguContent: '',
                    jinyongTypes: '',
                },
                sexTypesOptions : [],
                bumenTypesOptions : [],
                ...
                rules: {
                   ...
                   xueliTypes: [
                              { required: true, message: '学历状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinShixiContent: [
                              { required: true, message: '实习经历不能为空', trigger: 'blur' },
                          ],
                   shangpinRonguContent: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yuangongJiaoyuContent = _this.ruleForm.yuangongJiaoyuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.yuangongGongzuoContent = _this.ruleForm.yuangongGongzuoContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.shangpinShixiContent = _this.ruleForm.shangpinShixiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.shangpinRonguContent = _this.ruleForm.shangpinRonguContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yuangongJiaoyuContent = this.ruleForm.yuangongJiaoyuContent.replaceAll(this.$base.url,"");
                        this.ruleForm.yuangongGongzuoContent = this.ruleForm.yuangongGongzuoContent.replaceAll(this.$base.url,"");
                        this.ruleForm.shangpinShixiContent = this.ruleForm.shangpinShixiContent.replaceAll(this.$base.url,"");
                        this.ruleForm.shangpinRonguContent = this.ruleForm.shangpinRonguContent.replaceAll(this.$base.url,"");
                        this.$http({
