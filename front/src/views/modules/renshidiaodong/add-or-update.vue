    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yuangong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学历状态" prop="xueliValue">
                        <el-input v-model="yuangongForm.xueliValue"
                                  placeholder="学历状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="人事调动编号" prop="renshidiaodongUuidNumber">
                       <el-input v-model="ruleForm.renshidiaodongUuidNumber"
                                 placeholder="人事调动编号" clearable  :readonly="ro.renshidiaodongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="人事调动编号" prop="renshidiaodongUuidNumber">
                           <el-input v-model="ruleForm.renshidiaodongUuidNumber"
                                     placeholder="人事调动编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="人事调动类型" prop="renshidiaodongTypes">
                        <el-select v-model="ruleForm.renshidiaodongTypes" :disabled="ro.renshidiaodongTypes" placeholder="请选择人事调动类型">
                            <el-option
                                v-for="(item,index) in renshidiaodongTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="人事调动类型" prop="renshidiaodongValue">
                        <el-input v-model="ruleForm.renshidiaodongValue"
                            placeholder="人事调动类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.diaodongTime"  class="input" label="调动时间" prop="diaodongTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.diaodongTime"
                                type="datetime"
                                placeholder="调动时间"
                                :disabled="ro.diaodongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.diaodongTime" label="调动时间" prop="diaodongTime">
                            <span v-html="ruleForm.diaodongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.renshidiaodongContent"  label="调动缘由" prop="renshidiaodongContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.renshidiaodongContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.renshidiaodongContent" label="调动缘由" prop="renshidiaodongContent">
                            <span v-html="ruleForm.renshidiaodongContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    renshidiaodongUuidNumber: true,
                    renshidiaodongTypes: false,
                    diaodongTime: false,
                    yuanBumen: false,
                    yuanZhiwei: false,
                    bumenTypes: false,
                    zhiweiTypes: false,
                    renshidiaodongContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yuangongId: '',
                    renshidiaodongUuidNumber: new Date().getTime(),
                    renshidiaodongTypes: '',
                    diaodongTime: '',
                    yuanBumen: '',
                    yuanZhiwei: '',
                    bumenTypes: '',
                    zhiweiTypes: '',
                    renshidiaodongContent: '',
                    insertTime: '',
                },
                renshidiaodongTypesOptions : [],
                bumenTypesOptions : [],
                zhiweiTypesOptions : [],
                yuangongOptions : [],
                rules: {
                   ...
                   renshidiaodongUuidNumber: [
                              { required: true, message: '人事调动编号不能为空', trigger: 'blur' },
                          ],
                   renshidiaodongTypes: [
                              { required: true, message: '人事调动类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   diaodongTime: [
                              { required: true, message: '调动时间不能为空', trigger: 'blur' },
                          ],
                   yuanBumen: [
                   ...
                   renshidiaodongContent: [
                              { required: true, message: '调动缘由不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=renshidiaodong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.renshidiaodongTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `renshidiaodong/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.yuangongChange(data.data.yuangongId)
                        _this.ruleForm.renshidiaodongContent = _this.ruleForm.renshidiaodongContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.renshidiaodongContent = this.ruleForm.renshidiaodongContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`renshidiaodong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.renshidiaodongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
