    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假标题" prop="yuangongqingjiaName">
                       <el-input v-model="ruleForm.yuangongqingjiaName"
                                 placeholder="请假标题" clearable  :readonly="ro.yuangongqingjiaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="请假标题" prop="yuangongqingjiaName">
                           <el-input v-model="ruleForm.yuangongqingjiaName"
